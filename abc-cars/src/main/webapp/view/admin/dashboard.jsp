          ...
          <aside class="sidebar-admin pe-md-3">
            <ul>
              <li class="active-page">
                <a href="<%= request.getContextPath() %>/admin"><i class="fa-solid fa-gauge-high" style="color:#0D19A3"></i> Dashboard</a>
              </li>
              <li>
                <a href="<%= request.getContextPath() %>/admin/car-management"><i class="fa-solid fa-car" style="color:#0D19A3"></i> Car Management</a>
              </li>
            </ul>
          </aside>
