        ...
        <div class="container d-flex justify-content-center align-items-center">
          <div class="jumbotron-content pt-4">
            ...
            <div class="jumbotron-text">
              <h2 class="fw-bolder m-0" style="color:#15DB95"> FIND YOUR DREAM VEHICLE</h2>
              <h2 class="fw-bolder">It's better when you drive your dream</h2>
              <p>Only place for all your after-sale services including maintenance, service, repair and spare parts</p>
            </div>
            <a href="<%= request.getContextPath() %>/cars">
              <button class="btn-search btn text-uppercase mt-3" style="background-color:#fff">Search Cars</button>
            </a>
          </div>
        </div>
      </div>
